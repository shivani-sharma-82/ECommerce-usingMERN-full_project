...
toast.error(error.message)
    ...
    return(
        ...
        <div>
            <div><p className="mb-2">Upload Image</p>
        ...
        <div className="w-full">
            ...
            <input onChange={(e)=>setName(e.target.value)} value={name} className="w-full msx-w-[500px] px-3 py-2" type="text" placeholder="Type here" required />
        </div>
        <div className="w-full">
            <p className="mb-2">Product Description</p>
            <textarea  onChange={(e)=>setDescription(e.target.value)} value={description}  className="w-full msx-w-[500px] px-3 py-2" type="text" placeholder="Write content here" required />
        </div>
        ...
        <button type="submit" className="w-28 py-3 mt-4 bg-[#AF1740] text-white">Add</button>
        </form>
    )
}
export default Add